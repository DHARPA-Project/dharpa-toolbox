...
from dharpa_toolbox.modules.utils_old import load_workflows
...
app.include_router(module_router, prefix="/processing/processing")
...
app.include_router(doc_module_router, prefix="/doc/processing")
